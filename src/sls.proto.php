...
class Log
{
	...
	public function __toString()
	{
		return ''.Protobuf::toString('unknown', $this->_unknown).Protobuf::toString('time_',
				$this->time_).Protobuf::toString('contents_', $this->contents_);
	}
...
class LogGroupList
{
	...
	public function getLogGroupListCount()
	{
		if($this->logGroupList_ === null)
			return 0;
		else return count($this->logGroupList_);
	}
	...
	public function getLogGroupListArray()
	{
		if($this->logGroupList_ === null)
			return array();
		else return $this->logGroupList_;
	}
